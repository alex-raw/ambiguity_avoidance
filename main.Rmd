...
One is the deviation of proportions (DP.norm) [@gries08], more specifically the normalized version [cf. @lijffijt+gries12].
...
DWG is a measure of how regularly a token occurs across an entire corpuoccurs across an entire corpus.
